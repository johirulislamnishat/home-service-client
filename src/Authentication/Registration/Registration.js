                    ...
                    <div className="row d-flex">
                        <div className="col-lg-6 d-flex justify-content- center align-items- center">
                            <div className="card1 pb-5">
                                ...
                                <div className="row px-3 justify-content-center mt-4 mb-5 border-line"> <img src="https://i.ibb.co/1n7QLsP/slide3.png" className="image" alt='icon' /> </div>
                            </div>
                        </div>
                            ...
                            <div className="card2 card border-0 px-4 py-5">
                                <div>
                                    ...
                                    <form onSubmit={handleSignUp}>
                                        ...
                                        <div className="form-group">
                                            <button type="submit" className="btn-main btn-lg btn-block signup-btn">Sign Up</button>
                                        </div>
                                    </form>
